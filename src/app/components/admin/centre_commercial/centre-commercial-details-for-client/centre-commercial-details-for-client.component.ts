...
import {CentreCommercial, CentreCommercialCPLModel} from "../../../../models/mall.model";
...
} from "../onglet/centre-commercial-produit-liste/centre-commercial-produit-liste.component";
...
@Component({
  selector: 'app-centre-commercial-details-for-client',
  standalone: true,
  imports: [
    CentreCommercialBoutiqueListeComponent,
    CentreCommercialOffreListeComponent,
  ...
  templateUrl: './centre-commercial-details-for-client.component.html',
  styleUrl: './centre-commercial-details-for-client.component.css'
})
export class CentreCommercialDetailsForClientComponent {
  ...
  menuItems = [
    ...
    { id: 'tab2', label: 'ARTICLES', active: false }
  ];
  searchQuery = '';
  constructor(
