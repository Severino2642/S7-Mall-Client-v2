...
@Component({
  ...
  standalone: true,
  imports: [CommonModule,NavbarComponent, HeaderComponent, FormsModule,ReactiveFormsModule],
  templateUrl: './offre-location.form.component.html',
  styleUrl: './offre-location.form.component.css'
})
export class OffreLocationFormComponent {
