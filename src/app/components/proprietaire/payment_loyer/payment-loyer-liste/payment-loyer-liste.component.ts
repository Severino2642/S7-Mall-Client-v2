...
export class PaymentLoyerListeComponent {
  ...
  applyFilters():void{
    this.filteredItems = this.items.filter(item => {
      ...
      if (this.filters.boutique !== "" && this.roleUser === ConstanteUtil.role_centre_commercial && !UtilitaireUtil.compareMotCle(item.boutique?.nom, this.filters.boutique)) {
        return false;
      }
      if (this.filters.boutique !== "" && this.roleUser === ConstanteUtil.role_proprietaire && item.idBoutique !== this.filters.boutique) {
        return false;
      }
